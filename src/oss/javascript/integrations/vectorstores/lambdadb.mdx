...
<Note>
    If the specified collection does not exist, `LambdaDBVectorStore` will create it automatically.
</Note>
...
For detailed documentation of all `LambdaDBVectorStore` features and configurations, head to the [API reference](https://docs.lambdadb.ai/reference/api/introduction).
